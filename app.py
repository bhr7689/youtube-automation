...
2. 귀에 착착 들어와야 한다: 같은 음절 패턴 반복, 라임(각운) 맞추기, 받침 적게
3. 따라 부르기 쉬워야 한다: 코러스는 4마디 이내, 반복 구조, 음절 수 일정하게

【각 섹션 작사 가이드】
- [Verse]: 일상 속 구체적 장면 묘사. 누구나 공감하는 상황. 쉬운 단어로.
  ✅ "엄마가 끓여준 된장찌개 냄새"  ❌ "망각의 심연에 잠긴 기억의 편린"
- [Pre-Chorus]: 2~4줄, 짧고 강하게, 코러스 직전 감정 폭발 직전 상태
- [Chorus]: 핵심 감정 딱 한 줄 + 반복구. 처음 들어도 바로 따라 부를 수 있게.
  음절 수 고정 (예: 7·5 / 8·6 패턴), 라임 반드시 맞추기
- [Bridge]: 조용히 감정 반전, 새로운 멜로디 느낌으로 숨 고르기
- [Chorus 3]: 최종 클라이맥스. 앞 코러스보다 감정 한 단계 더 강하게.

【금지 사항】
- 어려운 단어, 긴 문장, 추상적 표현 금지
