...
THEMES = {
    "fresh_orange": {   # 🍊 범용 — 따뜻한 오렌지 (달콤·구움·기본)
        ...
        "badge_bg": "#ffc24d", "badge_text": "#2f1c05",
    },
    "appetite_red": {   # 🔥 식욕 레드 — 고기·매운맛·구이 (도파민 최강)
        ...
        "badge_bg": "#ff7a5c", "badge_text": "#2b0a02",
    },
    "juicy_berry": {    # 🍉 과즙 베리 — 수박·딸기·과일 (빨강 과육 + 초록 신선 대비)
        ...
        "badge_bg": "#ff8a94", "badge_text": "#3d0a10",
    },
    "ocean_fresh": {    # 🌊 바다 신선 — 수산물 (신뢰 청록 + CTA는 식욕 주황 유지)
        ...
        "cta_shadow": "rgba(234,88,12,0.35)",
        "badge_bg": "#7fe3f0", "badge_text": "#062a33",
    },
    "golden_honey": {   # 🍯 골든 허니 — 치킨·빵·꿀·튀김·고구마 (노릇노릇 황금)
        ...
        "badge_bg": "#ffd34d", "badge_text": "#2e1c02",
    },
}
...
CSS = """
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .hero-sub {
    font-size: 24px; font-weight: 600; opacity: 0.95; margin: 0; letter-spacing: -0.3px;
    text-shadow: 0 1px 8px rgba(0,0,0,0.5);
  }
  /* 이름 블록 */
  .name-block { padding: 40px 40px 10px; }
  .product-name {
    font-size: 38px; font-weight: 900; color: __PRIMARY_DEEP__; letter-spacing: -1px; margin: 0 0 8px;
  }
  .subtitle { font-size: 23px; font-weight: 500; color: #4b5563; margin: 0; letter-spacing: -0.3px; }
  /* HOOK (큰 후크 배너) */
  .hook {
  ...
  .appeal {
    background: __BADGE_BG__; border-radius: 14px;
    padding: 20px 8px; text-align: center;
    font-size: 21px; font-weight: 800; color: __BADGE_TEXT__;
  ...
  .section h2 .tag {
    ...
    font-size: 15px; font-weight: 800; color: __TAG_TEXT__;
    background: __TAG_BG__; border-radius: 999px; padding: 4px 12px; margin-right: 10px;
    letter-spacing: 0;
  }
  .section p { font-size: 24px; line-height: 1.75; color: #333d47; margin: 0; }
  ...
  .spec-table th { width: 34%; color: #6b7280; font-weight: 500; }
  .spec-table td { color: #191f28; font-weight: 700; }
  .spec-table tr:last-child th, .spec-table tr:last-child td { border-bottom: none; }
  .size-cards {
    display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-top: 18px;
  }
  .size-card {
    background: __BADGE_BG__; border-radius: 14px; padding: 18px 8px; text-align: center;
  }
  .size-card .label { font-size: 16px; color: __BADGE_TEXT__; font-weight: 700; opacity: 0.75; }
  .size-card .value { font-size: 22px; color: __BADGE_TEXT__; font-weight: 900; margin-top: 5px; }
  ...
  .review .text { font-size: 21px; color: #333d47; margin-top: 10px; line-height: 1.65; }
  ...
  .cta {
    ...
    background: __PRIMARY__; color: #fff; font-size: 32px; font-weight: 900;
    padding: 26px 16px; border-radius: 20px; text-decoration: none; letter-spacing: -0.5px;
